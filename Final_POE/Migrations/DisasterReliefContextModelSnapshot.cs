...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Final_POE.Models.AidType", b =>
                {
            ...
            modelBuilder.Entity("Final_POE.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("Final_POE.Models.Disaster", b =>
                {
            ...
            modelBuilder.Entity("Final_POE.Models.Donation.Good", b =>
                {
            ...
            modelBuilder.Entity("Final_POE.Models.Donation.Monetary", b =>
                {
            ...
            modelBuilder.Entity("Final_POE.Models.GoodsPurchase", b =>
                {
            ...
            modelBuilder.Entity("Final_POE.Models.Disaster", b =>
                {
                    b.HasOne("Final_POE.Models.AidType", "AidType")
                        .WithMany("Disasters")
            ...
            modelBuilder.Entity("Final_POE.Models.Donation.Good", b =>
                {
                    b.HasOne("Final_POE.Models.Category", "Category")
                        .WithMany("Goods")
                        .HasForeignKey("CategoryID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Final_POE.Models.Disaster", "Disaster")
                        .WithMany("Goods")
            ...
            modelBuilder.Entity("Final_POE.Models.GoodsPurchase", b =>
                {
                    ...
                    b.HasOne("Final_POE.Models.Donation.Monetary", "Monetary")
                        .WithMany()
